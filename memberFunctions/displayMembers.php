        ...
        <tr>
          ...
          <td>
            <div class='action-buttons'>";
              ...
              if ($row["membership_status"] == "cancelled"){ 
              echo
              "<form action='Members.php' method='post' onsubmit=\"return confirm('Are you sure you want to renew subscription for this member?')\">
                <input type='hidden' name='MemberID' value='" . $row["member_ID"] . "'>
                <input type='hidden' name='action' value='renew'>
                <button type='submit' class='action-btn renew' title='Renew Subscription'>
